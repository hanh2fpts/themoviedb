...
interface ToastApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: ToastApi?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.ToastApi.toastMessage", codec)
        if (api != null) {
